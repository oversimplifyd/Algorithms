...
public class LinkedListDeleteWithSideEffect {
    ...
    public static void deleteNode(LinkedListNode nodeToDelete) {
        ...
        if (nodeToDelete.next != null) {
            ...
            //Copies the value and next pointer of nextn ode into nodeToDelete 
            //Such that nodeToDelete now is a replica of the next node 
            //This techniqu has a lot of side effects, although it achieves the delete in O(1) time and O(1) space 
            nodeToDelete.value = nodeToDelete.next.value;
            nodeToDelete.next = nodeToDelete.next.next;
        } else {
            throw new IllegalArgumentException("Invalid, due to this weird techniue of deleeting node");
        }
    }
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(LinkedListDeleteWithSideEffect.class);
